...
{
   GtkListStore *retModel = gtk_list_store_new(NUM_SAMPLES_COLUMNS,
                                               G_TYPE_STRING,
                                               G_TYPE_FLOAT, G_TYPE_FLOAT, G_TYPE_FLOAT, G_TYPE_FLOAT,
                                               G_TYPE_DOUBLE, G_TYPE_DOUBLE);
   GtkTreeIter insertCursor;
   gtk_list_store_append(retModel, &insertCursor);
   gtk_list_store_set(retModel, &insertCursor,
   ...
   return GTK_TREE_MODEL(retModel);
}
